...
prob.rmse_prob_c1   = feGet(fe_prob_c1,'vox rmse');
det.rmse_det_c1   = feGet(fe_det_c1,'vox rmse');
...
prob.rmsexv_prob_c1   = feGet(fe_prob_c1,'vox rmse');
det.rmsexv_det_c1   = feGet(fe_det_c1,'vox rmse');
...
prob.rrmse_prob_c1   = feGetRep(fe_prob_c1,'vox rmse ratio');
det.rrmse_det_c1   = feGetRep(fe_det_c1,'vox rmse ratio');
...
%function [fh, fe] = life_BD_demo()
    ...
    % prob.w_prob_c1   = feGet(fe_prob_c1,'fiber weights');
...
rmse   = prob.rmse_prob_c1;
rmsexv = prob.rmsexv_prob_c1;
