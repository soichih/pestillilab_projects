...
## antsApplyWarp to move functional blobs to diffusion space
# antsApplyTransforms -d 3 -i tmaps2dwi.nii.gz -r t2.nii.gz -t antsDemo_0Warp.nii.gz -o antsApply_tmaps.nii.gz